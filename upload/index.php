...
//$folder_download = "/var/www/html/swcrediti/swcrediti2/download/";
	...
	<div class="row">
		...
		<div class="sidebar col-md-8">
			...
			<?php 
				...
				foreach ($sheetData as $k=> $t) {
			?>	
				<tr><td><?php echo $k + 1  ?><td><?php echo $t[0] ?></td><td><?php echo $t[1] ?></td><td><?php echo $t[2] ?></td><td><?php echo $t[3] ?></td></tr>
			<?php 
				}
			?>
				</tbody>
